...
- `doc_generator` — `doc-manifest.sqlite`: the page manifest (what was
  ...
  reproduce. (038) `doc_overview_narratives` keeps one raw Overview narrative
